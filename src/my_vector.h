...
template<typename T>
typename my_vector<T>::iterator const my_vector<T>::cbegin() {
    return array;
}
...
template<typename T>
typename my_vector<T>::iterator const my_vector<T>::cend() {
    return array + v_size;
}

template<typename T>
std::reverse_iterator<T> my_vector<T>::rbegin() {
    return std::reverse_iterator<T>(array + v_size);
}
...
template<typename T>
std::reverse_iterator<typename my_vector<T>::iterator const> my_vector<T>::rcbegin() {
    return std::reverse_iterator<my_vector::iterator const>(array + v_size);
}

template<typename T>
std::reverse_iterator<typename my_vector<T>::iterator const> my_vector<T>::rcend() {
    return std::reverse_iterator<my_vector::iterator const>(array);
}
